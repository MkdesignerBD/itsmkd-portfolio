...
export default function Tools() {
  ...
  // Feature Flags
  const IS_PAYMENT_ENABLED = false; // Set to true when payment gateway / bKash is ready
  ...
  return (
    <div className="bg-[#161616] text-white min-h-screen pb-20 overflow-hidden relative selection:bg-[#f15a28]/30 selection:text-white">
          ...
          >
            ...
            {IS_PAYMENT_ENABLED ? (
              ...
              <button
                disabled
                type="button"
                className="mt-8 w-full py-4 rounded-xl bg-white/10 border border-white/20 text-white/50 font-medium flex items-center justify-center gap-2 cursor-not-allowed text-center text-sm select-none"
              >
      ...
      {/* =================================================================
          ...
          ================================================================= */}
      <AnimatePresence>
        {IS_PAYMENT_ENABLED && showCheckoutModal && (
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
